        ...
        while (!ip.equals("stop")) {
            ...
            if (sq != (long) sq)
                ...
                if (cl.check(key, s)) {
                    ...
                    cl.divide(op, s);
                    cl.cofact(cl.keymatrix, s);
                    System.out.println("Encrypted Message: " + cl.encry);
                    out.println(cl.encry);
                }
            }
        }
        socket.close();
